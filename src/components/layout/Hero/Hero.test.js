...
describe('Component Hero', () => {
  it('should render without crashing', () => {
    const component = shallow(<Hero titleText='Lorem ipsum' imageSrc='sciezka' />);
  ...
  it('should render correct title', () => {
    ...
    const component = shallow(<Hero titleText={expectedTitle} imageSrc='sciezka' />);
  ...
  it('render HappyHourAd component', () => {
    const expectedTitle = 'Lorem ipsum';
    const expectedImage = 'image.jpg';
    const component = shallow(<Hero titleText={expectedTitle} imageSrc={expectedImage}/>)

    const renderHappyHour = component.find('HappyHourAd');
    expect(renderHappyHour.length).toEqual(1);
  });
